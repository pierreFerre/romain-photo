...
class Photography
{
    ...
    public function getTextualAlternative(): ?string
    {
        return $this->textualAlternative;
    }

    public function setTextualAlternative(?string $textualAlternative): self
    {
